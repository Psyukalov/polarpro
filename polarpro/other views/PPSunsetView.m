...
#define kMinAngle (-58.f)
#define kMaxAngle (58.f)



@interface PPSunsetView ()
...
- (void)loadViewFromNib {
    ...
    UINib *nib = [UINib nibWithNibName:@"PPSunsetView"
                                bundle:bundle];
...
- (void)setup {
    ...
    [self setDirection:-90.f
              animated:NO];
    [self setType:PPSunsetViewSmallType];
}

- (void)setType:(PPSunsetViewType)type {
    UIImage *circleImage;
    UIImage *lineImage;
    CGFloat constant;
    BOOL angleHidden;
    switch (type) {
        case PPSunsetViewSmallType: {
